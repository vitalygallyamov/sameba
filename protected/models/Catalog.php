...
class Catalog extends EActiveRecord
{
    ...
    {
        return array(
            array('gllr_gallery, category_id, seo_id, status, sort, on_main', 'numerical', 'integerOnly'=>true),
            array('name, alias, art_id, materials, places, price_desc, period', 'length', 'max'=>255),
