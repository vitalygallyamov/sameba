<?php
/**
 * Миграция m140220_163812_menu
 *
 * @property string $prefix
 */
 
class m140220_163812_menu extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{menu_types}}', '{{menu_items}}');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{menu_types}}', array(
			...
			'uniq_name' => "string NOT NULL COMMENT 'Уникальное имя'",
        ),
